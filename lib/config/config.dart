...
class Config {
  ...
  final String appName = 'SuroIAO Travel Guide'; 
  final String mapAPIKey = 'AIzaSyClsHb5kKWN*****************';
  final String countryName = 'Siargao Island';
  ...
  static final Color appThemeColor = const Color.fromARGB(255, 255, 196, 0);
